...
app.get("/healthz", (_req, res) => {
  res.json({
    ...
    build: "island-v9",
    features: ["obstacles", "island-maze", "zone-shrink", "mobile-sticks", "gorilla-flower", "reconnect", "sprite-key", "vendor-towers", "slime-avatars", "rocket-aoe", "flamethrower", "ice-bow"],
  });
});
