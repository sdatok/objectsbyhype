...
import { getOrCreateRedLightConfig, RED_LIGHT_CONFIG_ID } from "@/lib/red-light-config";
...
export async function POST() {
  ...
  try {
    ...
    const upstream = await fetch(`${baseUrl.replace(/\/$/, "")}/admin/red-light/end`, {
      method: "POST",
      headers: {
    ...
    console.error("[POST /api/admin/red-light/end]", err);
